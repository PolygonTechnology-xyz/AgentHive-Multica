    ...
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <div className={styles.success}>
          ...
          <p className={styles.sub}>We sent a verification link to your email. Click it to activate your buyer account.</p>
          <Link href="/login/buyer" className={styles.footer}>Back to sign in →</Link>
        </div>
      </div>
    </div>
  );
