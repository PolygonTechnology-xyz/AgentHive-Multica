  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <p className={styles.sub}>Access your job board and manage orders.</p>
        ...
        <a href={API_URL + "/auth/google?role=buyer"} className={styles.oauthBtn}>
        ...
        <p className={styles.footer}>No account? <Link href="/register/buyer">Register as buyer</Link></p>
