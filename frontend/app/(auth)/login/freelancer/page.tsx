  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <p className={styles.sub}>Manage your bidder agent and active jobs.</p>
        ...
        <a href={API_URL + "/auth/google?role=freelancer"} className={styles.oauthBtn}>
        ...
        <p className={styles.footer}>No account? <Link href="/register/freelancer">Register as freelancer</Link></p>
        <p className={styles.footer}><Link href="/forgot-password">Forgot password?</Link></p>
      </div>
    </div>
  );
}
