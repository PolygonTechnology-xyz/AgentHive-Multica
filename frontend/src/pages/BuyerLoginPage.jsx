...
/* ── Demo special-state email triggers ── */
const SPECIAL = {
...
const BuyerLoginPage = () => {
  ...
  const [loginState, setLoginState] = useState(''); // '' | 'invalid' | 'unverified' | 'deactivated'
    ...
    if (loginState === 'unverified') return (
      <div className="login-alert login-alert-warn">
        ...
        <span>
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); navigate('/register/buyer/verify', { state: { email } }); }}>
      ...
      <div className="login-page">
        <div className="login-card">
          <div className="login-head">
            ...
            <p className="login-sub">Sign in to your Buyer account</p>
          </div>
